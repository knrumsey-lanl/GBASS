...
#' @details Shortcut for specifying priors for the gbass() function
#' @export
#' @examples
...
#'
build_prior <- function(type, pars, prop_sigma=NULL){
  pr <- list(type=type, p=pars[1], a=pars[2], b=pars[3], prop_sigma=prop_sigma)
  return(pr)
}
